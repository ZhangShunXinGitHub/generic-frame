...
public class RedisServiceImpl<K,T> implements RedisService<K,T>{
    ...
    public boolean hasKey(String key){
        try {
            ...
            log.error("redis hasKey exception:{}",e);
            return false;
        }
    }
    ...
    public Set<Object> sGet(String key){
        try {
            ...
            log.error("redis sGet exception:{}",e);
            return null;
        }
    }
    ...
    public boolean sHasKey(String key,T value){
        try {
            ...
            log.error("redis sHasKey exception:{}",e);
            return false;
        }
    }
    ...
    public long sSetAndTime(String key,long time,T...values) {
        try {
            ...
            log.error("redis sSetAndTime exception:{}",e);
            return 0;
        }
    }
    ...
    public long sGetSetSize(String key){
        try {
            ...
            log.error("redis sGetSetSize exception:{}",e);
            return 0;
        }
    }
    ...
    public long setRemove(String key, T ...values) {
        try {
            ...
            log.error("redis setRemove exception:{}",e);
            return 0;
        }
    }
    //===============================list=================================
    ...
    public List<Object> lGet(String key, long start, long end){
        try {
            ...
            log.error("redis lGet exception:{}",e);
            return null;
        }
    }
    ...
    public long lGetListSize(String key){
        try {
            ...
            log.error("redis lGetListSize exception:{}",e);
            return 0;
        }
    }
    ...
    public Object lGetIndex(String key,long index){
        try {
            ...
            log.error("redis lGetIndex exception:{}",e);
            return null;
        }
    }
    ...
    public boolean lSet(String key, T value) {
        try {
            ...
            log.error("redis lSet exception:{}",e);
            return false;
        }
    }
    ...
    public boolean lUpdateIndex(String key, long index,T value) {
        try {
            ...
            log.error("redis lUpdateIndex exception:{}",e);
            return false;
        }
    }
    ...
    public long lRemove(String key,long count,T value) {
        try {
            ...
            log.error("redis lRemove exception:{}",e);
            return 0;
        }
    }
